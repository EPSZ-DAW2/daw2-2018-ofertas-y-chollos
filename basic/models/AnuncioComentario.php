 ...
 */
class AnuncioComentario extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * @inheritdoc
     * @return AnunciosComentariosQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new AnunciosComentariosQuery(get_called_class());
    }
}
