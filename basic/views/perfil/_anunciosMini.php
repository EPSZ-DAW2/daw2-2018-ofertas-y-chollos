	...
	<div class="card col-md-4 <?= ($desactivado)?' card-terminada-gris':''?>">
			...
			<div class="votos">
				...
				?>
					...
					<?php } 
					 ...
					 echo "Votos:".  Html::encode($numero_votos); ?>
		...
		<div class="card-block">
			...
			<h4 class="card-title"> <?= Html::a($model->titulo, ['anuncios/ver', 'id'=>$model->id], ['class' =>'waves-effect waves-light']) ?></h4>
				...
				if($model->url == null)	echo Html::a('Administrar', ['anuncios/update', 'id'=>$model->id], ['class' =>'btn btn-primary waves-effect waves-light btn-block']);
